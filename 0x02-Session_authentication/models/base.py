...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """ converting object into the JSON dictionary
        """
        result = {}
    ...
    def load_from_file(cls):
        """ loading all the objects from file
        """
    ...
    def save_to_file(cls):
        """ saving all the objects to file
        """
        s_class = cls.__name__
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def get(cls, id: str) -> TypeVar('Base'):
        """ returning one object by the id
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """ searching all objects by the matching attributes
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
